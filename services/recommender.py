...
class SHLRecommender:
    def __init__(self):
        ...
        def _add_to_collection(self, df: pd.DataFrame):
            documents = []
            metadatas = []
            source_urls = []
            ...
            # Use the new add_documents method with deduplication
    ...
    def hybrid_search(self, query: str, filters: Optional[chromadb.Where] = None, where_doc: Optional[chromadb.WhereDocument] = None) -> List[Dict]:
